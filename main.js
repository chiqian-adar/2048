    ...
    for (var i = 0; i < 4; i++) {
        for (var j = 0; j < 4; j++) {
            ...
            if (board[i][j] == 0) {
                ...
                theNumberCell.css('top', getPosTop(i, j) + cellSideLength / 2); //为什么不加单位？
            ...
            if (board[i][j] != 0) {
                for (var k = 3; k > j; k--) {
                    if (board[i][k] == 0 && noBlockHorizontal(i, j, k, board)) {
                        ...
                        continue;
                    } else if (board[i][k] == board[i][j] && noBlockVertical(i, j, k, board) && !hasConflicted[i][j]) {
